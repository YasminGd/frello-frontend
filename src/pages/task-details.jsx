  ...
  return (
    <React.Fragment>
      <section className="task-details">
        <button className="close-task-details" onClick={onGoBack}>
          <IoCloseOutline />
        </button>
        <section className="task-header">
          <GrCreditCard className="header-icon" />
          <textarea name="" value={titleTxt} onChange={handleChange} onBlur={setTaskTitle} />
          <div className="sub-title">in list {group.title}</div>
        </section>
        <div className="task-body">
          <section className="task-content">
            <section className="task-description">
              <div className="description-header">{/* stopped here for desc*/}</div>
          ...
          <section className="task-sidebar">
            ...
            <button className="btn-sidebar" onClick={() => onOpenActionModal('Attach from...')}>
