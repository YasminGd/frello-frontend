...
export const BoardHeader = () => {
    ...
    function displayTextWidth(text, font = `700 18px -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Noto Sans, Ubuntu, Droid Sans, Helvetica Neue, sans-serif`) {
    ...
    return <section className="board-header">
        ...
        <section className="right">
            <button><BsThreeDots />Show menu</button>
        </section>
    </section>
}